...
class ReleaseTests(unittest.TestCase):
    ...
    def test_mac_architecture_and_deployment_target(self):
        ...
        release.check_runtime("aarch64-apple-darwin", header, "  cmd LC_BUILD_VERSION\n  minos 13.0\n  sdk 15.5\n")
        release.check_runtime("aarch64-apple-darwin", header, "  cmd LC_VERSION_MIN_MACOSX\n  version 11.0\n")
        for invalid in ("  minos 14.0\n", "  minos 13.1\n", "  sdk 15.0\n"):
            with self.subTest(invalid=invalid), self.assertRaises(ValueError):
                release.check_runtime("aarch64-apple-darwin", header, invalid)
